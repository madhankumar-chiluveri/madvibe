...
For all workspace developer commands, folder structure maps, database/REST API guidelines, design decisions, and implementation rules, refer directly to **[AGENTS.md](file:///d:/Madhan_Utils/learnings/madvibe/AGENTS.md)**.
Do not maintain redundant guidelines or stale continuity logs in this file.
